...
/// for a caller holding <see cref="Allow.Platform_Administration"/>, and for that caller alone. Such a
/// caller runs in the platform scope, where the endpoint answers about the platform's own data - the
