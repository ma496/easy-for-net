...
public static class TestUsers
{
    ...
    /// away rather than passing everyone the way an all-permission seeded role would.
    /// </summary>
    public static Guid LimitedUserId { get; private set; } = default;

    /// <summary>
    /// <c>nomember</c> - an active account with <b>no</b> membership at all. The no-membership
