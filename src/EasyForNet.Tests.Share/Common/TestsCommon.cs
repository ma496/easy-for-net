...
namespace EasyForNet.Tests.Share.Common
{
    public abstract class TestsCommon : IDisposable
    {
        ...
        {
            var serviceProvider = CreateScope().ServiceProvider;
            return (serviceProvider.GetRequiredService<T1>(), serviceProvider.GetRequiredService<T2>(), serviceProvider.GetRequiredService<T3>());
        }
        
        protected (T1, T2, T3, T4) NewScopeService<T1, T2, T3, T4>()
        {
            var serviceProvider = CreateScope().ServiceProvider;
            return (serviceProvider.GetRequiredService<T1>(), serviceProvider.GetRequiredService<T2>(), serviceProvider.GetRequiredService<T3>(), serviceProvider.GetRequiredService<T4>());
        }
        
        protected (T1, T2, T3, T4, T5) NewScopeService<T1, T2, T3, T4, T5>()
        {
            var serviceProvider = CreateScope().ServiceProvider;
            return (serviceProvider.GetRequiredService<T1>(), serviceProvider.GetRequiredService<T2>(), serviceProvider.GetRequiredService<T3>(), serviceProvider.GetRequiredService<T4>(), serviceProvider.GetRequiredService<T5>());
        }
        
        protected (T1, T2, T3, T4, T5, T6) NewScopeService<T1, T2, T3, T4, T5, T6>()
        {
            var serviceProvider = CreateScope().ServiceProvider;
            return (serviceProvider.GetRequiredService<T1>(), serviceProvider.GetRequiredService<T2>(), serviceProvider.GetRequiredService<T3>(), serviceProvider.GetRequiredService<T4>(), serviceProvider.GetRequiredService<T5>(), serviceProvider.GetRequiredService<T6>());
        }
        
        protected (T1, T2, T3, T4, T5, T6, T7) NewScopeService<T1, T2, T3, T4, T5, T6, T7>()
        {
            var serviceProvider = CreateScope().ServiceProvider;
            return (serviceProvider.GetRequiredService<T1>(), serviceProvider.GetRequiredService<T2>(), serviceProvider.GetRequiredService<T3>(), serviceProvider.GetRequiredService<T4>(), serviceProvider.GetRequiredService<T5>(), serviceProvider.GetRequiredService<T6>(), serviceProvider.GetRequiredService<T7>());
        }
        
        protected (T1, T2, T3, T4, T5, T6, T7, T8) NewScopeService<T1, T2, T3, T4, T5, T6, T7, T8>()
        {
            var serviceProvider = CreateScope().ServiceProvider;
            return (serviceProvider.GetRequiredService<T1>(), serviceProvider.GetRequiredService<T2>(), serviceProvider.GetRequiredService<T3>(), serviceProvider.GetRequiredService<T4>(), serviceProvider.GetRequiredService<T5>(), serviceProvider.GetRequiredService<T6>(), serviceProvider.GetRequiredService<T7>(), serviceProvider.GetRequiredService<T8>());
        }
        
        protected (T1, T2, T3, T4, T5, T6, T7, T8, T9) NewScopeService<T1, T2, T3, T4, T5, T6, T7, T8, T9>()
        {
            var serviceProvider = CreateScope().ServiceProvider;
            return (serviceProvider.GetRequiredService<T1>(), serviceProvider.GetRequiredService<T2>(), serviceProvider.GetRequiredService<T3>(), serviceProvider.GetRequiredService<T4>(), serviceProvider.GetRequiredService<T5>(), serviceProvider.GetRequiredService<T6>(), serviceProvider.GetRequiredService<T7>(), serviceProvider.GetRequiredService<T8>(), serviceProvider.GetRequiredService<T9>());
        }
        
        protected (T1, T2, T3, T4, T5, T6, T7, T8, T9, T10) NewScopeService<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>()
        {
            var serviceProvider = CreateScope().ServiceProvider;
            return (serviceProvider.GetRequiredService<T1>(), serviceProvider.GetRequiredService<T2>(), serviceProvider.GetRequiredService<T3>(), serviceProvider.GetRequiredService<T4>(), serviceProvider.GetRequiredService<T5>(), serviceProvider.GetRequiredService<T6>(), serviceProvider.GetRequiredService<T7>(), serviceProvider.GetRequiredService<T8>(), serviceProvider.GetRequiredService<T9>(), serviceProvider.GetRequiredService<T10>());
        }
