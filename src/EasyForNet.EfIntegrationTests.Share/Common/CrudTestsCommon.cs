...
{
    public abstract class CrudTestsCommon<TCrudActions, TEntity, TKey, TListDto, TCreateDto, TUpdateDto, TGetDto> : TestsCommon
        ...
        where TGetDto : class, IDto<TKey>
    {
        ...
        protected delegate string PrepareForCreateUniqueProperty(TCreateDto dto); // Modify dto and return unique property name
        
        protected virtual async Task InternalCreateDuplicateTest(int count, int uniquePropertiesCount, BeforeCreateDuplicateDelegate
        ...
        protected delegate string PrepareForUpdateUniqueProperty(TCreateDto dto, List<TCreateDto> dtos); // Modify dto and return unique property name
